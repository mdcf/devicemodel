# -*- coding: utf-8 -*-
#
# MDCF Device Modeling documentation build configuration file, created by
...
project = u'MDCF Device Modeling Language (DML)'
copyright = u'2013, Robby'
...
htmlhelp_basename = 'MDCFDeviceModelingdoc'
...
latex_documents = [
  ('index', 'MDCFDeviceModeling.tex', u'MDCF Device Modeling Documentation',
   u'Robby', 'manual'),
]
...
man_pages = [
    ('index', 'mdcfdevicemodeling', u'MDCF Device Modeling Documentation',
     [u'Robby'], 1)
]
...
texinfo_documents = [
  ('index', 'MDCFDeviceModeling', u'MDCF Device Modeling Documentation',
   u'Robby', 'MDCFDeviceModeling', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'MDCF Device Modeling'
epub_author = u'Robby'
epub_publisher = u'Robby'
epub_copyright = u'2013, Robby'
...
extlinks = {'dml': ('https://github.com/mdcf/devicemodel/blob/master/mdcf-dml-ast/src/main/java/edu/ksu/cis/santos/mdcf/dml/%s', ''),
            ...
            'dmsx': ('https://github.com/mdcf/devicemodel/blob/master/mdcf-dms-example/src/main/scala/edu/ksu/cis/santos/mdcf/dms/examplev2/%s', ''),
            'dmsjx': ('https://github.com/mdcf/devicemodel/blob/master/mdcf-dms-example/src/main/java/edu/ksu/cis/santos/mdcf/dms/examplev2/%s', ''),
