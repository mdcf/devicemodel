 ...
 */
public final class ConstAnnotation extends AstNode
    implements AttributeAnnotation {

  public final FeatureLevel level;
  public final String qualifier;

  public ConstAnnotation(final FeatureLevel level, final String qualifier) {
    this.level = level;
  ...
  protected boolean visit(final IVisitor visitor) {
    return visitor.visitConstAnnotation(this);
  }
}
