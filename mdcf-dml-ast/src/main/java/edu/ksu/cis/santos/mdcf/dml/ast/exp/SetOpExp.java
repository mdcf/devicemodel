 ...
 */
public final class SetOpExp extends Exp {
  public final String id;
  public final Exp exp;

  public SetOpExp(final String id, final Exp exp) {
    this.id = id.intern();
    this.exp = exp;
  }

  SetOpExp(final String id, final Exp exp, final Type type) {
    super(type);
    this.id = id.intern();
    this.exp = exp;
  }
  ...
  protected boolean visit(final IVisitor visitor) {
    ...
    final boolean b2 = visitor.visitSetOpExp(this);
    return b1 && b2;
  }

  @Override
  public Exp withType(final Type type) {
    return new SetOpExp(this.id, this.exp, type);
  }
}
