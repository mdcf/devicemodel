...
public class XStreamer {
  ...
  public static XStream xstream(final boolean isXml) {
    ...
    result.alias("accessExp", AccessExp.class);
    result.alias("applyExp", ApplyExp.class);
    result.alias("binaryBasicOpExp", BinaryBasicOpExp.class);
    result.alias("defaultMatchCaseBindExp", DefaultMatchCaseBind.class);
    result.alias("funExp", FunExp.class);
    result.alias("instanceOfExp", InstanceOfExp.class);
    ...
    result.alias("setOpExp", SetOpExp.class);
    result.alias("tupleOpExp", TupleOpExp.class);
    result.alias("unknownExp", UnknownExp.class);
    result.alias("varRefExp", VarRefExp.class);
