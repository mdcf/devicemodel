 ...
 */
public final class TupleOpExp extends Exp {
  public final String id;
  public final Exp exp;

  public TupleOpExp(final String id, final Exp exp) {
    this.id = id.intern();
    this.exp = exp;
  }

  TupleOpExp(final String id, final Exp exp, final Type type) {
    super(type);
    this.id = id.intern();
    this.exp = exp;
  }
  ...
  protected boolean visit(final IVisitor visitor) {
    ...
    final boolean b2 = visitor.visitTupleOpExp(this);
    return b1 && b2;
  }

  @Override
  public Exp withType(final Type type) {
    return new TupleOpExp(this.id, this.exp, type);
  }
}
