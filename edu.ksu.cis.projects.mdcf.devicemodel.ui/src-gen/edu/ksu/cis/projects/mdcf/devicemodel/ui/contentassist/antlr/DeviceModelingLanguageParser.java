		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSubMemberDeclAccess().getAlternatives_2(), "rule__SubMemberDecl__Alternatives_2");
					put(grammarAccess.getSubMemberMatchAccess().getAlternatives_2(), "rule__SubMemberMatch__Alternatives_2");
					put(grammarAccess.getConstraintNatAccess().getAlternatives(), "rule__ConstraintNat__Alternatives");
					put(grammarAccess.getAppOrComponentAccess().getAlternatives(), "rule__AppOrComponent__Alternatives");
					put(grammarAccess.getAppRequirementAccess().getAlternatives_4(), "rule__AppRequirement__Alternatives_4");
					...
					put(grammarAccess.getSubMemberDeclAccess().getGroup_2_0(), "rule__SubMemberDecl__Group_2_0__0");
					put(grammarAccess.getSubMemberDeclAccess().getGroup_2_0_2(), "rule__SubMemberDecl__Group_2_0_2__0");
					put(grammarAccess.getSubMemberDeclAccess().getGroup_2_0_3(), "rule__SubMemberDecl__Group_2_0_3__0");
					put(grammarAccess.getSubMemberDeclAccess().getGroup_2_1(), "rule__SubMemberDecl__Group_2_1__0");
					...
					put(grammarAccess.getSubMemberMatchAccess().getGroup_1(), "rule__SubMemberMatch__Group_1__0");
					...
					put(grammarAccess.getAppRequirementAccess().getGroup(), "rule__AppRequirement__Group__0");
					put(grammarAccess.getAppRequirementAccess().getGroup_4_0(), "rule__AppRequirement__Group_4_0__0");
					put(grammarAccess.getAppRequirementAccess().getGroup_4_0_2(), "rule__AppRequirement__Group_4_0_2__0");
					put(grammarAccess.getAppRequirementAccess().getGroup_4_0_3(), "rule__AppRequirement__Group_4_0_3__0");
					put(grammarAccess.getAppRequirementAccess().getGroup_4_1(), "rule__AppRequirement__Group_4_1__0");
					...
					put(grammarAccess.getSubMemberDeclAccess().getSupersAssignment_2_0_1(), "rule__SubMemberDecl__SupersAssignment_2_0_1");
					put(grammarAccess.getSubMemberDeclAccess().getSupersAssignment_2_0_2_1(), "rule__SubMemberDecl__SupersAssignment_2_0_2_1");
					put(grammarAccess.getSubMemberDeclAccess().getMembersAssignment_2_0_3_1(), "rule__SubMemberDecl__MembersAssignment_2_0_3_1");
					put(grammarAccess.getSubMemberDeclAccess().getMembersAssignment_2_1_1(), "rule__SubMemberDecl__MembersAssignment_2_1_1");
					...
					put(grammarAccess.getSubMemberMatchAccess().getQNamesAssignment_1_0(), "rule__SubMemberMatch__QNamesAssignment_1_0");
					put(grammarAccess.getSubMemberMatchAccess().getNameAssignment_2_0(), "rule__SubMemberMatch__NameAssignment_2_0");
					put(grammarAccess.getSubMemberMatchAccess().getAnyAssignment_2_1(), "rule__SubMemberMatch__AnyAssignment_2_1");
					put(grammarAccess.getConstraintNatAccess().getNumAssignment_0_1(), "rule__ConstraintNat__NumAssignment_0_1");
					put(grammarAccess.getAppRequirementAccess().getNameAssignment_1(), "rule__AppRequirement__NameAssignment_1");
					put(grammarAccess.getAppRequirementAccess().getDevicesAssignment_3(), "rule__AppRequirement__DevicesAssignment_3");
					put(grammarAccess.getAppRequirementAccess().getSupersAssignment_4_0_1(), "rule__AppRequirement__SupersAssignment_4_0_1");
					put(grammarAccess.getAppRequirementAccess().getSupersAssignment_4_0_2_1(), "rule__AppRequirement__SupersAssignment_4_0_2_1");
					put(grammarAccess.getAppRequirementAccess().getMembersAssignment_4_0_3_1(), "rule__AppRequirement__MembersAssignment_4_0_3_1");
					put(grammarAccess.getAppRequirementAccess().getMembersAssignment_4_1_1(), "rule__AppRequirement__MembersAssignment_4_1_1");
					put(grammarAccess.getDeviceAccess().getNameAssignment_0(), "rule__Device__NameAssignment_0");
					put(grammarAccess.getDeviceAccess().getTypeAssignment_2(), "rule__Device__TypeAssignment_2");
