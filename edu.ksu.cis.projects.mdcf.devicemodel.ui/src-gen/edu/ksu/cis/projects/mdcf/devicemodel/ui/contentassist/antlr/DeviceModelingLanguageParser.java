		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFeatureTypeAccess().getGroup_6(), "rule__FeatureType__Group_6__0");
					put(grammarAccess.getFeatureTypeAccess().getGroup_6_5(), "rule__FeatureType__Group_6_5__0");
					put(grammarAccess.getFeatureTypeAccess().getGroup_6_5_2(), "rule__FeatureType__Group_6_5_2__0");
					put(grammarAccess.getFeatureTypeAccess().getGroup_6_5_2_1(), "rule__FeatureType__Group_6_5_2_1__0");
					...
					put(grammarAccess.getFeatureTypeAccess().getBaseAssignment_6_3(), "rule__FeatureType__BaseAssignment_6_3");
					put(grammarAccess.getFeatureTypeAccess().getElementsAssignment_6_5_2_0(), "rule__FeatureType__ElementsAssignment_6_5_2_0");
					put(grammarAccess.getFeatureTypeAccess().getElementsAssignment_6_5_2_1_1(), "rule__FeatureType__ElementsAssignment_6_5_2_1_1");
