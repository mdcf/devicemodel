		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTypeAccess().getAlternatives_0_0_2(), "rule__Type__Alternatives_0_0_2");
					...
					put(grammarAccess.getTypeAccess().getGroup_0_0(), "rule__Type__Group_0_0__0");
					put(grammarAccess.getTypeAccess().getGroup_0_0_2_0(), "rule__Type__Group_0_0_2_0__0");
					put(grammarAccess.getTypeAccess().getGroup_0_0_2_1(), "rule__Type__Group_0_0_2_1__0");
					put(grammarAccess.getTypeAccess().getGroup_0_1(), "rule__Type__Group_0_1__0");
					put(grammarAccess.getTypeAccess().getGroup_0_1_3(), "rule__Type__Group_0_1_3__0");
					...
					put(grammarAccess.getTypeAccess().getBaseTypeAssignment_0_0_1(), "rule__Type__BaseTypeAssignment_0_0_1");
					put(grammarAccess.getTypeAccess().getElemTypesAssignment_0_1_2(), "rule__Type__ElemTypesAssignment_0_1_2");
					put(grammarAccess.getTypeAccess().getElemTypesAssignment_0_1_3_1(), "rule__Type__ElemTypesAssignment_0_1_3_1");
