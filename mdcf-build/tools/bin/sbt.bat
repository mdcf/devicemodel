...
java -Dfile.encoding=UTF8 %JAVA_OPTS% -XX:ReservedCodeCacheSize=%RESERVED_CODE_CACHE_SIZE% -Xss1M -XX:+CMSClassUnloadingEnabled -Xmx%JAVA_HEAP_SIZE% -jar %PROJECT_DIR%\tools\bin\sbt-launch-0.13.2.jar %SBT_OPTS% %*