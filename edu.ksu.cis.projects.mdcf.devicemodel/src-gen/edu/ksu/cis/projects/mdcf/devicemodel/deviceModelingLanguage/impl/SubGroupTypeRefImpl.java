 ...
 * @generated
 */
public class SubGroupTypeRefImpl extends SubGroupTypeImpl implements SubGroupTypeRef
{
  /**
   ...
   * @ordered
   */
  protected FeatureGroupDecl type;
   ...
   * @generated
   */
  public FeatureGroupDecl getType()
  {
    if (type != null && type.eIsProxy())
    {
      InternalEObject oldType = (InternalEObject)type;
      type = (FeatureGroupDecl)eResolveProxy(oldType);
      if (type != oldType)
      {
   ...
   * @generated
   */
  public FeatureGroupDecl basicGetType()
  {
    return type;
  }
   ...
   * @generated
   */
  public void setType(FeatureGroupDecl newType)
  {
    FeatureGroupDecl oldType = type;
    type = newType;
    if (eNotificationRequired())
  ...
  public void eSet(int featureID, Object newValue)
  {
    ...
    {
      case DeviceModelingLanguagePackage.SUB_GROUP_TYPE_REF__TYPE:
        setType((FeatureGroupDecl)newValue);
        return;
    }
