 ...
 * <ul>
 *   <li>{@link edu.ksu.cis.projects.mdcf.devicemodel.deviceModelingLanguage.impl.SetLiteralImpl#getBasicType <em>Basic Type</em>}</li>
...
public class SetLiteralImpl extends LiteralImpl implements SetLiteral
{
  ...
  public NotificationChain basicSetBasicType(BasicType newBasicType, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DeviceModelingLanguagePackage.SET_LITERAL__BASIC_TYPE, oldBasicType, newBasicType);
  ...
  public void setBasicType(BasicType newBasicType)
  {
    if (newBasicType != basicType)
    {
      ...
      if (basicType != null)
        msgs = ((InternalEObject)basicType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DeviceModelingLanguagePackage.SET_LITERAL__BASIC_TYPE, null, msgs);
      if (newBasicType != null)
        msgs = ((InternalEObject)newBasicType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DeviceModelingLanguagePackage.SET_LITERAL__BASIC_TYPE, null, msgs);
      msgs = basicSetBasicType(newBasicType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DeviceModelingLanguagePackage.SET_LITERAL__BASIC_TYPE, newBasicType, newBasicType));
  }
