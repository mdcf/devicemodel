 ...
 * <ul>
 *   <li>{@link edu.ksu.cis.projects.mdcf.devicemodel.deviceModelingLanguage.impl.SetLiteralImpl#getTypeCons <em>Type Cons</em>}</li>
...
public class SetLiteralImpl extends LiteralImpl implements SetLiteral
{
    ...
    if (typeCons != null && typeCons.eIsProxy())
    {
      ...
      if (typeCons != oldTypeCons)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DeviceModelingLanguagePackage.SET_LITERAL__TYPE_CONS, oldTypeCons, typeCons));
      }
    }
    return typeCons;
  }
  ...
  public void setTypeCons(TypeDecl newTypeCons)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DeviceModelingLanguagePackage.SET_LITERAL__TYPE_CONS, oldTypeCons, typeCons));
  }
  ...
  public EList<ELiteral> getElems()
  {
    if (elems == null)
    {
      elems = new EObjectContainmentEList<ELiteral>(ELiteral.class, this, DeviceModelingLanguagePackage.SET_LITERAL__ELEMS);
    }
    return elems;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DeviceModelingLanguagePackage.SET_LITERAL__TYPE_CONS:
