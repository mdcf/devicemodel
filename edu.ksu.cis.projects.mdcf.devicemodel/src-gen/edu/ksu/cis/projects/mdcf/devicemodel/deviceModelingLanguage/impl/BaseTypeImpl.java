 ...
 * <ul>
 *   <li>{@link edu.ksu.cis.projects.mdcf.devicemodel.deviceModelingLanguage.impl.BaseTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BaseTypeImpl extends TypeImpl implements BaseType
{
  ...
  {
    return DeviceModelingLanguagePackage.Literals.BASE_TYPE;
  }
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DeviceModelingLanguagePackage.BASE_TYPE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(TypeDecl newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DeviceModelingLanguagePackage.BASE_TYPE__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DeviceModelingLanguagePackage.BASE_TYPE__TYPE:
