 ...
 * @generated
 */
public class OptionTypeImpl extends BaseTypeImpl implements OptionType
{
  /**
  ...
  public NotificationChain basicSetBase(Type newBase, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DeviceModelingLanguagePackage.OPTION_TYPE__BASE, oldBase, newBase);
  ...
  public void setBase(Type newBase)
  {
    if (newBase != base)
    {
      ...
      if (base != null)
        msgs = ((InternalEObject)base).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DeviceModelingLanguagePackage.OPTION_TYPE__BASE, null, msgs);
      if (newBase != null)
        msgs = ((InternalEObject)newBase).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DeviceModelingLanguagePackage.OPTION_TYPE__BASE, null, msgs);
      msgs = basicSetBase(newBase, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DeviceModelingLanguagePackage.OPTION_TYPE__BASE, newBase, newBase));
  }
