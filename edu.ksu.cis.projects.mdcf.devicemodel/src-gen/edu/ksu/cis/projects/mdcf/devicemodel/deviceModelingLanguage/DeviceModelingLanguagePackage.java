...
public interface DeviceModelingLanguagePackage extends EPackage
{
   ...
   * @ordered
   */
  int OPTION_TYPE__BASE = TYPE_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int OPTION_TYPE_FEATURE_COUNT = TYPE_FEATURE_COUNT + 1;
